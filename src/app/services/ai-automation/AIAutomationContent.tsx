...
const processKeys = [
  ...
  { number: '02', titleKey: 'servicePages.aiAutomation.process_2_title', textKey: 'servicePages.aiAutomation.process_2_text' },
  { number: '03', titleKey: 'servicePages.aiAutomation.process_3_title', textKey: 'servicePages.aiAutomation.process_3_text' },
  { number: '04', titleKey: 'servicePages.aiAutomation.process_4_title', textKey: 'servicePages.aiAutomation.process_4_text' },
] as const
            ...
            <div>
              ...
              <div className="flex flex-col gap-8 mb-16">
                <div className="p-6 rounded-2xl transition-all duration-500 hover:bg-[rgba(14,14,17,0.02)] hover:-translate-y-1">
                  <h3 className="text-2xl font-semibold text-text-dark mb-3 font-manrope">{p('crm')}</h3>
                  <p className="text-base leading-relaxed text-text-dark opacity-70">{p('crm_desc')}</p>
                </div>
                <div className="p-6 rounded-2xl transition-all duration-500 hover:bg-[rgba(14,14,17,0.02)] hover:-translate-y-1">
                  <h3 className="text-2xl font-semibold text-text-dark mb-3 font-manrope">{p('contentProcesses')}</h3>
                  <p className="text-base leading-relaxed text-text-dark opacity-70">{p('contentProcesses_desc')}</p>
                </div>
                <div className="p-6 rounded-2xl transition-all duration-500 hover:bg-[rgba(14,14,17,0.02)] hover:-translate-y-1">
                  <h3 className="text-2xl font-semibold text-text-dark mb-3 font-manrope">{p('formsData')}</h3>
                  <p className="text-base leading-relaxed text-text-dark opacity-70">{p('formsData_desc')}</p>
                </div>
              </div>
