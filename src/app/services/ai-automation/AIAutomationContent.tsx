            ...
            <div>
              ...
              <div className="flex flex-col gap-8 mb-16">
                <div className="p-6 rounded-2xl border border-slate-200 bg-white transition-all duration-500 hover:bg-slate-50 hover:-translate-y-1">
                  <h3 className="text-2xl font-semibold text-slate-900 mb-3 font-manrope">{p('crm')}</h3>
                  <p className="text-base leading-relaxed text-slate-700">{p('crm_desc')}</p>
                </div>
                <div className="p-6 rounded-2xl border border-slate-200 bg-white transition-all duration-500 hover:bg-slate-50 hover:-translate-y-1">
                  <h3 className="text-2xl font-semibold text-slate-900 mb-3 font-manrope">{p('contentProcesses')}</h3>
                  <p className="text-base leading-relaxed text-slate-700">{p('contentProcesses_desc')}</p>
                </div>
                <div className="p-6 rounded-2xl border border-slate-200 bg-white transition-all duration-500 hover:bg-slate-50 hover:-translate-y-1">
                  <h3 className="text-2xl font-semibold text-slate-900 mb-3 font-manrope">{p('formsData')}</h3>
                  <p className="text-base leading-relaxed text-slate-700">{p('formsData_desc')}</p>
                </div>
              </div>
