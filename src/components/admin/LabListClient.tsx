...
import { createConceptDraftAction } from '@/lib/actions/admin-actions'
  ...
  return (
    <main className="min-h-0 flex-1 overflow-y-auto">
      <div className="mx-auto max-w-5xl px-6 py-8 md:px-10 md:py-10">
        <AdminBreadcrumbs items={[{ label: 'Lab', href: '/admin/lab' }, { label: 'All concepts' }]} />
        <div className="mb-8 flex flex-col gap-4 border-b border-neutral-800 pb-6 md:flex-row md:items-end md:justify-between">
          <div>
            <h1 className="text-2xl font-semibold tracking-tight text-white">All concepts</h1>
            <p className="mt-1 text-sm text-neutral-500">Lab / concepts collection.</p>
          </div>
